...
writeArchive(
  "lastfirst", //class of the div that you want this section of the archive to appear in. to have it be on your html page, make an empty div with this class.
...
writeArchive("lastfirst", 0, 0, 0, true, true);
